...
//!   report — `LimitEvidence` / `LimitVerdict` — saying whether an applied cap
//!   then actually *fired*. Implies `stats`.
...
#[cfg(feature = "limits")]
pub use limits::{LimitEvidence, LimitKind, LimitReason, LimitVerdict, ResourceLimits};
#[cfg(feature = "process-control")]
